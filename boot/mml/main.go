...
func init() {
	...
	mml.Modules.Set(modulePath, func() map[string]interface{} {
		...
		exports["sub"] = _sub
		_eq = _binaryOp.(*mml.Function).Call((&mml.List{Values: []interface{}{}}).Values)
		exports["eq"] = _eq
	...
	mml.Modules.Set(modulePath, func() map[string]interface{} {
		...
		_validateUse = &mml.Function{
			F: func(a []interface{}) interface{} {
				...
				if c.(bool) {
					mml.Nop()
					c = _definedCurrent.(*mml.Function).Call((&mml.List{Values: append([]interface{}{}, _context, mml.Ref(_u, "path"))}).Values)
					if c.(bool) {
						mml.Nop()
				...
				if c.(bool) {
					...
					for _, _name := range mml.Ref(_u, "exportNames").(*mml.List).Values {
						...
						mml.Nop()
						c = _definedCurrent.(*mml.Function).Call((&mml.List{Values: append([]interface{}{}, _context, _name)}).Values)
						if c.(bool) {
							mml.Nop()
				...
				c = _definedCurrent.(*mml.Function).Call((&mml.List{Values: append([]interface{}{}, _context, mml.Ref(_u, "capture"))}).Values)
				if c.(bool) {
					mml.Nop()
					return _resultErrors.(*mml.Function).Call((&mml.List{Values: append([]interface{}{}, _duplicate.(*mml.Function).Call((&mml.List{Values: append([]interface{}{}, mml.Ref(_u, "path"))}).Values))}).Values)
				}
