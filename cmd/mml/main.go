...
func init() {
	...
	mml.Modules.Set(modulePath, func() map[string]interface{} {
		...
		mml.Nop(_builtin, _builtins, _compileModuleCode, _compileModules, _modules, _fold, _foldr, _map, _filter, _contains, _sort, _join, _joins, _joinTwo, _formats, _formatOne, _escape, _unescape, _ifErr, _not, _yes, _passErr, _onlyErr, _anyErr, _log, _compile, _parseModules)
		...
		_sort = __list["sort"]
		var __strings = mml.Modules.Use("strings.mml")
		_join = __strings["join"]
		_joins = __strings["joins"]
		_joinTwo = __strings["joinTwo"]
		_formats = __strings["formats"]
		_formatOne = __strings["formatOne"]
		_escape = __strings["escape"]
		_unescape = __strings["unescape"]
		var __errors = mml.Modules.Use("errors.mml")
		_ifErr = __errors["ifErr"]
		_not = __errors["not"]
		_yes = __errors["yes"]
		_passErr = __errors["passErr"]
		_onlyErr = __errors["onlyErr"]
		_anyErr = __errors["anyErr"]
		var __log = mml.Modules.Use("log.mml")
		_log = __log["log"]
		var __compile = mml.Modules.Use("compile.mml")
		_compile = __compile["compile"]
		var __parse = mml.Modules.Use("parse.mml")
		_parseModules = __parse["parseModules"]
	...
	mml.Modules.Set(modulePath, func() map[string]interface{} {
		...
		var _contains interface{}
		var _sort interface{}
		mml.Nop(_fold, _foldr, _map, _filter, _contains, _sort)
		_fold = &mml.Function{
			F: func(a []interface{}) interface{} {
				var c interface{}
				mml.Nop(c)
	...
	mml.Modules.Set(modulePath, func() map[string]interface{} {
		...
		var _contains interface{}
		var _sort interface{}
		mml.Nop(_ifErr, _not, _yes, _passErr, _onlyErr, _anyErr, _fold, _foldr, _map, _filter, _contains, _sort)
		var __list = mml.Modules.Use("list.mml")
		_fold = __list["fold"]
		_foldr = __list["foldr"]
		_map = __list["map"]
	...
	mml.Modules.Set(modulePath, func() map[string]interface{} {
		...
		var _escape interface{}
		var _unescape interface{}
		mml.Nop(_log, _fold, _foldr, _map, _filter, _contains, _sort, _join, _joins, _joinTwo, _formats, _formatOne, _escape, _unescape)
		var __list = mml.Modules.Use("list.mml")
		_fold = __list["fold"]
		_foldr = __list["foldr"]
		_map = __list["map"]
	...
	mml.Modules.Set(modulePath, func() map[string]interface{} {
		...
		mml.Nop(_passErrFormat, _notEmpty, _compileInt, _compileFloat, _compileBool, _getScope, _mapCompile, _mapCompileJoin, _compileComment, _compileString, _compileSymbol, _compileCond, _compileSpread, _compileCase, _compileSend, _compileReceive, _compileGo, _compileDefer, _compileDefinitions, _compileAssigns, _compileRet, _compileControl, _compileList, _compileEntry, _compileStruct, _compileParamList, _compileFunction, _compileRangeExpression, _compileIndexer, _compileApplication, _compileUnary, _compileBinary, _compileTernary, _compileIf, _compileSwitch, _compileSelect, _compileRangeOver, _compileLoop, _compileDefinition, _compileAssign, _compileStatements, _compileModule, _getModuleName, _compileUse, _compileUseList, _compile, _fold, _foldr, _map, _filter, _contains, _sort, _ifErr, _not, _yes, _passErr, _onlyErr, _anyErr, _join, _joins, _joinTwo, _formats, _formatOne, _escape, _unescape, _counter, _enum, _log, _getFlattenedStatements, _controlStatement, _breakControl, _continueControl, _unaryOp, _binaryNot, _plus, _minus, _logicalNot, _binaryOp, _binaryAnd, _binaryOr, _xor, _andNot, _lshift, _rshift, _mul, _div, _mod, _add, _sub, _eq, _notEq, _less, _lessOrEq, _greater, _greaterOrEq, _logicalAnd, _logicalOr)
		var __list = mml.Modules.Use("list.mml")
		_fold = __list["fold"]
		_foldr = __list["foldr"]
		_map = __list["map"]
		...
		_escape = __strings["escape"]
		_unescape = __strings["unescape"]
		var __ints = mml.Modules.Use("ints.mml")
		_counter = __ints["counter"]
		_enum = __ints["enum"]
		var __log = mml.Modules.Use("log.mml")
		_log = __log["log"]
		var __statements = mml.Modules.Use("statements.mml")
		_getFlattenedStatements = __statements["getFlattenedStatements"]
		var __code = mml.Modules.Use("code.mml")
		_controlStatement = __code["controlStatement"]
		_breakControl = __code["breakControl"]
		_continueControl = __code["continueControl"]
		_unaryOp = __code["unaryOp"]
		_binaryNot = __code["binaryNot"]
		_plus = __code["plus"]
		_minus = __code["minus"]
		_logicalNot = __code["logicalNot"]
		_binaryOp = __code["binaryOp"]
		_binaryAnd = __code["binaryAnd"]
		_binaryOr = __code["binaryOr"]
		_xor = __code["xor"]
		_andNot = __code["andNot"]
		_lshift = __code["lshift"]
		_rshift = __code["rshift"]
		_mul = __code["mul"]
		_div = __code["div"]
		_mod = __code["mod"]
		_add = __code["add"]
		...
		_notEq = __code["notEq"]
		_less = __code["less"]
		_lessOrEq = __code["lessOrEq"]
		_greater = __code["greater"]
		_greaterOrEq = __code["greaterOrEq"]
		_logicalAnd = __code["logicalAnd"]
		_logicalOr = __code["logicalOr"]
		...
		_getScope = &mml.Function{
			F: func(a []interface{}) interface{} {
				...
				var _notInlineUses interface{}
				mml.Nop(_defs, _uses, _inlineUses, _notInlineUses)
				...
				_notInlineUses = _filter.(*mml.Function).Call(append([]interface{}{}, &mml.Function{
					F: func(a []interface{}) interface{} {
						var c interface{}
						mml.Nop(c)
						var _u = a[0]
						...
						mml.Nop(_u)
						return mml.BinaryOp(12, mml.Ref(_u, "capture"), ".")
					},
					FixedArgs: 1,
				})).(*mml.Function).Call(append([]interface{}{}, _uses))
				return append(append(append([]interface{}{}, _map.(*mml.Function).Call(append([]interface{}{}, &mml.Function{
					...
					FixedArgs: 1,
				}, _notInlineUses)).([]interface{})...), _inlineUses.([]interface{})...)
				return nil
			},
			FixedArgs: 0,
		}
				...
				_selectSpread = &mml.Function{
					F: func(a []interface{}) interface{} {
						...
						return func() interface{} {
							...
							if c.(bool) {
								return func() interface{} { s := make(map[string]interface{}); s["spread"] = _c; ; return s }()
							} else {
								return _c
							}
						}()
					...
					F: func(a []interface{}) interface{} {
						...
						_appendNewSimple = &mml.Function{
							F: func(a []interface{}) interface{} {
								...
								mml.Nop()
								return append(append([]interface{}{}, _groups.([]interface{})...), func() interface{} {
									s := make(map[string]interface{})
									s["simple"] = append([]interface{}{}, _item)
									return s
								}())
							},
							FixedArgs: 0,
						...
						_appendNewSpread = &mml.Function{
							F: func(a []interface{}) interface{} {
								...
								return append(append([]interface{}{}, _groups.([]interface{})...), func() interface{} {
									s := make(map[string]interface{})
									s["spread"] = append([]interface{}{}, mml.Ref(_item, "spread"))
									return s
								}())
							},
							FixedArgs: 0,
						...
						_appendSimple = &mml.Function{
							F: func(a []interface{}) interface{} {
								...
								mml.Nop()
								return append(append([]interface{}{}, mml.RefRange(_groups, nil, _i).([]interface{})...), func() interface{} {
									s := make(map[string]interface{})
									s["simple"] = append(append([]interface{}{}, mml.Ref(mml.Ref(_groups, _i), "simple").([]interface{})...), _item)
									return s
								}())
							},
							FixedArgs: 0,
						...
						_appendSpread = &mml.Function{
							F: func(a []interface{}) interface{} {
								...
								return append(append([]interface{}{}, mml.RefRange(_groups, nil, _i).([]interface{})...), func() interface{} {
									s := make(map[string]interface{})
									s["spread"] = append(append([]interface{}{}, mml.Ref(mml.Ref(_groups, _i), "spread").([]interface{})...), mml.Ref(_item, "spread"))
									return s
								}())
							},
							FixedArgs: 0,
		...
		_compileStruct = &mml.Function{
			F: func(a []interface{}) interface{} {
				...
				mml.Nop(_values)
				_values = _map.(*mml.Function).Call(append([]interface{}{}, &mml.Function{
					F: func(a []interface{}) interface{} {
						var c interface{}
						mml.Nop(c)
						var _e = a[0]
						...
						if c.(bool) {
							...
							_var = _formats.(*mml.Function).Call(append([]interface{}{}, "sp := %s.(map[string]interface{});", _compile.(*mml.Function).Call(append([]interface{}{}, mml.Ref(_e, "value")))))
						...
						c = _isString.(*mml.Function).Call(append([]interface{}{}, mml.Ref(_e, "key")))
						if c.(bool) {
							mml.Nop()
				...
				return _formats.(*mml.Function).Call(append([]interface{}{}, "func() interface{} { s := make(map[string]interface{}); %s; return s }()", _join.(*mml.Function).Call(append([]interface{}{}, "", _values))))
				return nil
			},
			FixedArgs: 1,
		}
		...
		_compileApplication = &mml.Function{
			F: func(a []interface{}) interface{} {
				...
				}(), _compile.(*mml.Function).Call(append([]interface{}{}, mml.Ref(_a, "function"))), _compileList.(*mml.Function).Call(append([]interface{}{}, func() interface{} { s := make(map[string]interface{}); s["values"] = mml.Ref(_a, "args"); ; return s }()))))
			},
			FixedArgs: 1,
		}
		...
		_compileAssign = &mml.Function{
			F: func(a []interface{}) interface{} {
				...
				return _passErrFormat.(*mml.Function).Call(append([]interface{}{}, "mml.SetRef(%s, %s, %s)", _compile.(*mml.Function).Call(append([]interface{}{}, mml.Ref(mml.Ref(_a, "capture"), "expression"))), _compile.(*mml.Function).Call(append([]interface{}{}, mml.Ref(mml.Ref(_a, "capture"), "index"))), _compile.(*mml.Function).Call(append([]interface{}{}, mml.Ref(_a, "value")))))
				return nil
			},
			FixedArgs: 1,
		}
	...
	mml.Modules.Set(modulePath, func() map[string]interface{} {
		...
		var _contains interface{}
		var _sort interface{}
		mml.Nop(_getFlattenedStatements, _fold, _foldr, _map, _filter, _contains, _sort)
		var __list = mml.Modules.Use("list.mml")
		_fold = __list["fold"]
		_foldr = __list["foldr"]
		_map = __list["map"]
		...
		exports["getFlattenedStatements"] = _getFlattenedStatements
		return exports
	})
	modulePath = "list.mml"
	mml.Modules.Set(modulePath, func() map[string]interface{} {
	...
	mml.Modules.Set(modulePath, func() map[string]interface{} {
		...
		var _counter interface{}
		var _enum interface{}
		mml.Nop(_controlStatement, _breakControl, _continueControl, _unaryOp, _binaryNot, _plus, _minus, _logicalNot, _binaryOp, _binaryAnd, _binaryOr, _xor, _andNot, _lshift, _rshift, _mul, _div, _mod, _add, _sub, _eq, _notEq, _less, _lessOrEq, _greater, _greaterOrEq, _logicalAnd, _logicalOr, _counter, _enum)
		var __ints = mml.Modules.Use("ints.mml")
		_counter = __ints["counter"]
		_enum = __ints["enum"]
	...
	mml.Modules.Set(modulePath, func() map[string]interface{} {
		...
		_parseString = &mml.Function{
			F: func(a []interface{}) interface{} {
				...
				mml.Nop()
				return _unescape.(*mml.Function).Call(append([]interface{}{}, mml.RefRange(mml.Ref(_ast, "text"), 1, mml.BinaryOp(10, _len.(*mml.Function).Call(append([]interface{}{}, mml.Ref(_ast, "text"))), 1))))
				return nil
			},
			FixedArgs: 1,
		}
		_parseSymbol = &mml.Function{
			F: func(a []interface{}) interface{} {
				...
				case "break":
					...
					return func() interface{} {
						s := make(map[string]interface{})
						s["type"] = "control-statement"
						s["control"] = _breakControl
						return s
					}()
				case "continue":
		...
		_parseSpread = &mml.Function{
			F: func(a []interface{}) interface{} {
				...
				return func() interface{} {
					s := make(map[string]interface{})
					s["type"] = "spread"
					s["value"] = _parse.(*mml.Function).Call(append([]interface{}{}, mml.Ref(mml.Ref(_ast, "nodes"), 0)))
					return s
				}()
				return nil
			},
		...
		_parseList = &mml.Function{
			F: func(a []interface{}) interface{} {
				...
				return func() interface{} {
					s := make(map[string]interface{})
					s["type"] = "list"
					s["values"] = _parseExpressionList.(*mml.Function).Call(append([]interface{}{}, mml.Ref(_ast, "nodes")))
					s["mutable"] = false
					return s
				}()
				return nil
		...
		_parseMutableList = &mml.Function{
			F: func(a []interface{}) interface{} {
				...
				return func() interface{} {
					s := make(map[string]interface{})
					sp := _parseList.(*mml.Function).Call(append([]interface{}{}, _ast)).(map[string]interface{})
					for k, v := range sp {
						s[k] = v
					}
					s["mutable"] = true
		...
		_parseEntry = &mml.Function{
			F: func(a []interface{}) interface{} {
				...
				return func() interface{} {
					s := make(map[string]interface{})
					s["type"] = "entry"
					s["key"] = _parse.(*mml.Function).Call(append([]interface{}{}, mml.Ref(mml.Ref(_ast, "nodes"), 0)))
					s["value"] = _parse.(*mml.Function).Call(append([]interface{}{}, mml.Ref(mml.Ref(_ast, "nodes"), 1)))
					return s
				}()
				return nil
			},
		...
		_parseStruct = &mml.Function{
			F: func(a []interface{}) interface{} {
				...
				return func() interface{} {
					s := make(map[string]interface{})
					s["type"] = "struct"
					s["entries"] = _map.(*mml.Function).Call(append([]interface{}{}, _parse, mml.Ref(_ast, "nodes")))
					s["mutable"] = false
					return s
				}()
				return nil
		...
		_parseMutableStruct = &mml.Function{
			F: func(a []interface{}) interface{} {
				...
				return func() interface{} {
					s := make(map[string]interface{})
					sp := _parseStruct.(*mml.Function).Call(append([]interface{}{}, _ast)).(map[string]interface{})
					for k, v := range sp {
						s[k] = v
					}
					s["mutable"] = true
		...
		_parseReturn = &mml.Function{
			F: func(a []interface{}) interface{} {
				...
				mml.Nop()
				return func() interface{} {
					c = mml.BinaryOp(11, _len.(*mml.Function).Call(append([]interface{}{}, mml.Ref(_ast, "nodes"))), 0)
					if c.(bool) {
						return func() interface{} { s := make(map[string]interface{}); s["type"] = "ret"; ; return s }()
					} else {
						return func() interface{} {
							s := make(map[string]interface{})
							s["type"] = "ret"
		...
		_parseStatementList = &mml.Function{
			F: func(a []interface{}) interface{} {
				...
				return func() interface{} {
					s := make(map[string]interface{})
					s["type"] = "statement-list"
					s["statements"] = _map.(*mml.Function).Call(append([]interface{}{}, _parse, mml.Ref(_ast, "nodes")))
					return s
				}()
				return nil
			},
		...
		_parseFunctionFact = &mml.Function{
			F: func(a []interface{}) interface{} {
				...
				return func() interface{} {
					s := make(map[string]interface{})
					s["type"] = "function"
					s["params"] = _map.(*mml.Function).Call(append([]interface{}{}, &mml.Function{
						F: func(a []interface{}) interface{} {
							var c interface{}
							mml.Nop(c)
							var _p = a[0]
						...
						FixedArgs: 1,
					})).(*mml.Function).Call(append([]interface{}{}, _map.(*mml.Function).Call(append([]interface{}{}, _parse)).(*mml.Function).Call(append([]interface{}{}, _fixedParams))))
					s["collectParam"] = func() interface{} {
						c = _hasCollectParam
						if c.(bool) {
							return mml.Ref(_parse.(*mml.Function).Call(append([]interface{}{}, mml.Ref(mml.Ref(mml.Ref(_params, _lastParam), "nodes"), 0))), "name")
						} else {
							return ""
						}
					}()
					s["statement"] = _parse.(*mml.Function).Call(append([]interface{}{}, mml.Ref(_nodes, _last)))
					s["effect"] = false
					return s
				}()
				return nil
		...
		_parseEffect = &mml.Function{
			F: func(a []interface{}) interface{} {
				...
				return func() interface{} {
					s := make(map[string]interface{})
					sp := _parseFunction.(*mml.Function).Call(append([]interface{}{}, _ast)).(map[string]interface{})
					for k, v := range sp {
						s[k] = v
					}
					s["effect"] = true
		...
		_parseRangeIndex = &mml.Function{
			F: func(a []interface{}) interface{} {
				...
				c = mml.BinaryOp(11, _len.(*mml.Function).Call(append([]interface{}{}, mml.Ref(_ast, "nodes"))), 1)
				if c.(bool) {
					mml.Nop()
					return _r
				}
				return func() interface{} {
					s := make(map[string]interface{})
					sp := _r.(map[string]interface{})
					for k, v := range sp {
						s[k] = v
					}
					s["to"] = mml.Ref(_parse.(*mml.Function).Call(append([]interface{}{}, mml.Ref(mml.Ref(_ast, "nodes"), 1))), "to")
					return s
				}()
				return nil
			},
		...
		_parseIndexerNodes = &mml.Function{
			F: func(a []interface{}) interface{} {
				...
				return func() interface{} {
					s := make(map[string]interface{})
					s["type"] = "indexer"
					s["expression"] = func() interface{} {
						c = mml.BinaryOp(11, _len.(*mml.Function).Call(append([]interface{}{}, _n)), 2)
						if c.(bool) {
							return _parse.(*mml.Function).Call(append([]interface{}{}, mml.Ref(_n, 0)))
						} else {
							return _parseIndexerNodes.(*mml.Function).Call(append([]interface{}{}, mml.RefRange(_n, nil, mml.BinaryOp(10, _len.(*mml.Function).Call(append([]interface{}{}, _n)), 1))))
						}
					}()
					s["index"] = _parse.(*mml.Function).Call(append([]interface{}{}, mml.Ref(_n, mml.BinaryOp(10, _len.(*mml.Function).Call(append([]interface{}{}, _n)), 1))))
					return s
				}()
				return nil
			},
		...
		_parseFunctionApplication = &mml.Function{
			F: func(a []interface{}) interface{} {
				...
				return func() interface{} {
					s := make(map[string]interface{})
					s["type"] = "function-application"
					s["function"] = _parse.(*mml.Function).Call(append([]interface{}{}, mml.Ref(mml.Ref(_ast, "nodes"), 0)))
					s["args"] = _parseExpressionList.(*mml.Function).Call(append([]interface{}{}, mml.RefRange(mml.Ref(_ast, "nodes"), 1, nil)))
					return s
				}()
				return nil
			},
		...
		_parseUnaryExpression = &mml.Function{
			F: func(a []interface{}) interface{} {
				...
				return func() interface{} {
					...
					s["type"] = "unary"
					s["op"] = _op
					s["arg"] = _parse.(*mml.Function).Call(append([]interface{}{}, mml.Ref(mml.Ref(_ast, "nodes"), 1)))
					return s
				}()
				return nil
			},
		...
		_parseBinaryExpression = &mml.Function{
			F: func(a []interface{}) interface{} {
				...
				return func() interface{} {
					...
					s["type"] = "binary"
					s["op"] = _op
					s["left"] = _parse.(*mml.Function).Call(append([]interface{}{}, func() interface{} {
						c = mml.BinaryOp(15, _len.(*mml.Function).Call(append([]interface{}{}, mml.Ref(_ast, "nodes"))), 3)
						if c.(bool) {
							return func() interface{} {
								s := make(map[string]interface{})
								s["name"] = mml.Ref(_ast, "name")
								s["nodes"] = mml.RefRange(mml.Ref(_ast, "nodes"), nil, mml.BinaryOp(10, _len.(*mml.Function).Call(append([]interface{}{}, mml.Ref(_ast, "nodes"))), 2))
								return s
							}()
						} else {
					...
					s["right"] = _parse.(*mml.Function).Call(append([]interface{}{}, mml.Ref(mml.Ref(_ast, "nodes"), mml.BinaryOp(10, _len.(*mml.Function).Call(append([]interface{}{}, mml.Ref(_ast, "nodes"))), 1))))
					return s
				}()
				return nil
			},
		...
		_parseChaining = &mml.Function{
			F: func(a []interface{}) interface{} {
				...
				for {
					...
					mml.Nop()
					c = mml.BinaryOp(11, _len.(*mml.Function).Call(append([]interface{}{}, _n)), 0)
					if c.(bool) {
						mml.Nop()
						return _a
					}
					_a = func() interface{} {
						s := make(map[string]interface{})
						s["type"] = "function-application"
						s["function"] = _parse.(*mml.Function).Call(append([]interface{}{}, mml.Ref(_n, 0)))
						s["args"] = append([]interface{}{}, _a)
						return s
					}()
		...
		_parserTernary = &mml.Function{
			F: func(a []interface{}) interface{} {
				...
				return func() interface{} {
					s := make(map[string]interface{})
					s["type"] = "cond"
					s["condition"] = _parse.(*mml.Function).Call(append([]interface{}{}, mml.Ref(mml.Ref(_ast, "nodes"), 0)))
					s["consequent"] = _parse.(*mml.Function).Call(append([]interface{}{}, mml.Ref(mml.Ref(_ast, "nodes"), 1)))
					s["alternative"] = _parse.(*mml.Function).Call(append([]interface{}{}, mml.Ref(mml.Ref(_ast, "nodes"), 2)))
					s["ternary"] = true
					return s
				}()
				return nil
		...
		_parseIf = &mml.Function{
			F: func(a []interface{}) interface{} {
				...
				c = mml.BinaryOp(11, _len.(*mml.Function).Call(append([]interface{}{}, mml.Ref(_ast, "nodes"))), 2)
				if c.(bool) {
					mml.Nop()
					return _cond
				}
				_alternative = func() interface{} {
					c = mml.BinaryOp(11, _len.(*mml.Function).Call(append([]interface{}{}, mml.Ref(_ast, "nodes"))), 3)
					if c.(bool) {
						return _parse.(*mml.Function).Call(append([]interface{}{}, mml.Ref(mml.Ref(_ast, "nodes"), 2)))
					} else {
						return _parse.(*mml.Function).Call(append([]interface{}{}, func() interface{} {
							s := make(map[string]interface{})
							sp := _ast.(map[string]interface{})
							for k, v := range sp {
								s[k] = v
							}
							s["nodes"] = mml.RefRange(mml.Ref(_ast, "nodes"), 2, nil)
							return s
						}()))
					}
				}()
				return func() interface{} {
					s := make(map[string]interface{})
					sp := _cond.(map[string]interface{})
					for k, v := range sp {
						s[k] = v
					}
					s["alternative"] = _alternative
					return s
				}()
				return nil
			},
			...
			F: func(a []interface{}) interface{} {
				...
				_expression = func() interface{} {
					...
					if c.(bool) {
						...
						return func() interface{} { s := make(map[string]interface{}); ; return s }()
					}
				}()
					...
					F: func(a []interface{}) interface{} {
						...
						for _, _n := range _nodes.([]interface{}) {
							...
							case "case":
								...
								mml.Nop()
								c = mml.BinaryOp(15, _len.(*mml.Function).Call(append([]interface{}{}, _current)), 0)
								if c.(bool) {
									mml.Nop()
									c = _isDefault
									if c.(bool) {
							...
							case "default":
								...
								mml.Nop()
								c = (mml.BinaryOp(15, _len.(*mml.Function).Call(append([]interface{}{}, _current)), 0).(bool) && !_isDefault.(bool))
								if c.(bool) {
									mml.Nop()
									_cases = append(append([]interface{}{}, _cases.([]interface{})...), _current)
								}
						...
						return _map.(*mml.Function).Call(append([]interface{}{}, &mml.Function{
							F: func(a []interface{}) interface{} {
								...
								return func() interface{} {
									s := make(map[string]interface{})
									s["type"] = "switch-case"
									s["expression"] = _parse.(*mml.Function).Call(append([]interface{}{}, mml.Ref(_c, 0)))
									s["body"] = func() interface{} {
										s := make(map[string]interface{})
										s["type"] = "statement-list"
										s["statements"] = _map.(*mml.Function).Call(append([]interface{}{}, _parse, mml.RefRange(_c, 1, nil)))
										return s
									}()
									return s
								}()
				...
				_s = func() interface{} {
					s := make(map[string]interface{})
					s["type"] = "switch-statement"
					s["cases"] = _parseCases.(*mml.Function).Call(append([]interface{}{}, mml.Ref(_lines, "cases")))
					s["defaultStatements"] = func() interface{} {
						s := make(map[string]interface{})
						s["type"] = "statement-list"
						s["statements"] = _map.(*mml.Function).Call(append([]interface{}{}, _parse, mml.Ref(_lines, "defaults")))
						return s
					}()
					return s
				}()
				return func() interface{} {
					...
					if c.(bool) {
						return func() interface{} {
							s := make(map[string]interface{})
							sp := _s.(map[string]interface{})
							for k, v := range sp {
								s[k] = v
							}
							s["expression"] = _parse.(*mml.Function).Call(append([]interface{}{}, _expression))
							return s
						}()
					} else {
						return _s
		...
		_parseRangeOver = &mml.Function{
			F: func(a []interface{}) interface{} {
				...
				c = (mml.BinaryOp(11, _len.(*mml.Function).Call(append([]interface{}{}, mml.Ref(_ast, "nodes"))), 1).(bool) && mml.BinaryOp(11, mml.Ref(mml.Ref(mml.Ref(_ast, "nodes"), 0), "name"), "symbol").(bool))
				if c.(bool) {
					mml.Nop()
					return func() interface{} {
						s := make(map[string]interface{})
						s["type"] = "range-over"
						s["symbol"] = mml.Ref(_parse.(*mml.Function).Call(append([]interface{}{}, mml.Ref(mml.Ref(_ast, "nodes"), 0))), "name")
						return s
					}()
				}
				_parseExpression = &mml.Function{
					F: func(a []interface{}) interface{} {
						...
						c = ((!_has.(*mml.Function).Call(append([]interface{}{}, "type", _exp)).(bool) || mml.BinaryOp(12, mml.Ref(_exp, "type"), "range-expression").(bool)) || mml.BinaryOp(11, _len.(*mml.Function).Call(append([]interface{}{}, _nodes)), 1).(bool))
						if c.(bool) {
							mml.Nop()
							return _exp
						}
						return func() interface{} {
							s := make(map[string]interface{})
							sp := _exp.(map[string]interface{})
							for k, v := range sp {
								s[k] = v
							}
							s["to"] = mml.Ref(_parse.(*mml.Function).Call(append([]interface{}{}, mml.Ref(_nodes, 1))), "to")
							return s
						}()
						return nil
					},
				...
				if c.(bool) {
					...
					return func() interface{} {
						s := make(map[string]interface{})
						s["type"] = "range-over"
						s["expression"] = _parseExpression.(*mml.Function).Call(append([]interface{}{}, mml.Ref(_ast, "nodes")))
						return s
					}()
				}
				return func() interface{} {
					...
					s["type"] = "range-over"
					s["symbol"] = mml.Ref(_parse.(*mml.Function).Call(append([]interface{}{}, mml.Ref(mml.Ref(_ast, "nodes"), 0))), "name")
					s["expression"] = _parseExpression.(*mml.Function).Call(append([]interface{}{}, mml.RefRange(mml.Ref(_ast, "nodes"), 1, nil)))
					return s
				}()
				return nil
			},
		...
		_parseLoop = &mml.Function{
			F: func(a []interface{}) interface{} {
				...
				if c.(bool) {
					...
					return func() interface{} {
						s := make(map[string]interface{})
						sp := _loop.(map[string]interface{})
						for k, v := range sp {
							s[k] = v
						}
						s["body"] = _parseStatementList.(*mml.Function).Call(append([]interface{}{}, mml.Ref(mml.Ref(_ast, "nodes"), 0)))
						return s
					}()
				}
				...
				return func() interface{} {
					...
					if c.(bool) {
						return func() interface{} {
							...
							s["body"] = _parseStatementList.(*mml.Function).Call(append([]interface{}{}, mml.Ref(mml.Ref(_ast, "nodes"), 1)))
							return s
						}()
					} else {
						return func() interface{} {
		...
		_parseValueCapture = &mml.Function{
			F: func(a []interface{}) interface{} {
				...
				return func() interface{} {
					...
					s["type"] = "definition"
					s["symbol"] = mml.Ref(_parse.(*mml.Function).Call(append([]interface{}{}, mml.Ref(mml.Ref(_ast, "nodes"), 0))), "name")
					s["expression"] = _parse.(*mml.Function).Call(append([]interface{}{}, mml.Ref(mml.Ref(_ast, "nodes"), 1)))
					s["mutable"] = false
					s["exported"] = false
					return s
				}()
		...
		_parseMutableCapture = &mml.Function{
			F: func(a []interface{}) interface{} {
				...
				return func() interface{} {
					s := make(map[string]interface{})
					sp := _parseValueCapture.(*mml.Function).Call(append([]interface{}{}, _ast)).(map[string]interface{})
					for k, v := range sp {
						s[k] = v
					}
					s["mutable"] = true
		...
		_parseDefinitions = &mml.Function{
			F: func(a []interface{}) interface{} {
				...
				return func() interface{} {
					s := make(map[string]interface{})
					s["type"] = "definition-list"
					s["definitions"] = _filter.(*mml.Function).Call(append([]interface{}{}, &mml.Function{
						F: func(a []interface{}) interface{} {
							var c interface{}
							mml.Nop(c)
							var _c = a[0]
						...
						FixedArgs: 1,
					})).(*mml.Function).Call(append([]interface{}{}, _map.(*mml.Function).Call(append([]interface{}{}, _parse)).(*mml.Function).Call(append([]interface{}{}, mml.Ref(_ast, "nodes")))))
					return s
				}()
				return nil
			},
		...
		_parseMutableDefinitions = &mml.Function{
			F: func(a []interface{}) interface{} {
				...
				return func() interface{} {
					s := make(map[string]interface{})
					sp := _dl.(map[string]interface{})
					for k, v := range sp {
						s[k] = v
					}
					s["definitions"] = _map.(*mml.Function).Call(append([]interface{}{}, &mml.Function{
						F: func(a []interface{}) interface{} {
							var c interface{}
							mml.Nop(c)
							var _d = a[0]
						...
						FixedArgs: 1,
					})).(*mml.Function).Call(append([]interface{}{}, mml.Ref(_dl, "definitions")))
					return s
				}()
				return nil
			},
		...
		_parseFunctionCapture = &mml.Function{
			F: func(a []interface{}) interface{} {
				...
				return func() interface{} {
					...
					s["type"] = "definition"
					s["symbol"] = mml.Ref(_parse.(*mml.Function).Call(append([]interface{}{}, mml.Ref(mml.Ref(_ast, "nodes"), 0))), "name")
					s["expression"] = _parseFunctionFact.(*mml.Function).Call(append([]interface{}{}, mml.RefRange(mml.Ref(_ast, "nodes"), 1, nil)))
					s["exported"] = false
					return s
				}()
				return nil
		...
		_parseEffectCapture = &mml.Function{
			F: func(a []interface{}) interface{} {
				...
				return func() interface{} {
					s := make(map[string]interface{})
					sp := _f.(map[string]interface{})
					for k, v := range sp {
						s[k] = v
					}
					s["expression"] = func() interface{} {
						s := make(map[string]interface{})
						sp := mml.Ref(_f, "expression").(map[string]interface{})
						for k, v := range sp {
							s[k] = v
						}
						s["effect"] = true
		...
		_parseAssignCaptures = &mml.Function{
			F: func(a []interface{}) interface{} {
				...
				mml.Nop()
				c = mml.BinaryOp(11, _len.(*mml.Function).Call(append([]interface{}{}, _nodes)), 0)
				if c.(bool) {
					mml.Nop()
					return []interface{}{}
				}
				return append(append([]interface{}{}, func() interface{} {
					s := make(map[string]interface{})
					s["type"] = "assign"
					s["capture"] = _parse.(*mml.Function).Call(append([]interface{}{}, mml.Ref(_nodes, 0)))
					s["value"] = _parse.(*mml.Function).Call(append([]interface{}{}, mml.Ref(_nodes, 1)))
					return s
				}()), _parseAssignCaptures.(*mml.Function).Call(append([]interface{}{}, mml.RefRange(_nodes, 2, nil))).([]interface{})...)
				return nil
			},
			FixedArgs: 1,
		}
		_parseAssign = &mml.Function{
			F: func(a []interface{}) interface{} {
				...
				return func() interface{} {
					s := make(map[string]interface{})
					s["type"] = "assign-list"
					s["assignments"] = _parseAssignCaptures.(*mml.Function).Call(append([]interface{}{}, mml.Ref(_ast, "nodes")))
					return s
				}()
				return nil
			},
		...
		_parseSend = &mml.Function{
			F: func(a []interface{}) interface{} {
				...
				return func() interface{} {
					s := make(map[string]interface{})
					s["type"] = "send"
					s["channel"] = _parse.(*mml.Function).Call(append([]interface{}{}, mml.Ref(mml.Ref(_ast, "nodes"), 0)))
					s["value"] = _parse.(*mml.Function).Call(append([]interface{}{}, mml.Ref(mml.Ref(_ast, "nodes"), 1)))
					return s
				}()
				return nil
		...
		_parseGo = &mml.Function{
			F: func(a []interface{}) interface{} {
				...
				return func() interface{} {
					s := make(map[string]interface{})
					s["type"] = "go"
					s["application"] = _parse.(*mml.Function).Call(append([]interface{}{}, mml.Ref(mml.Ref(_ast, "nodes"), 0)))
					return s
				}()
				return nil
			},
		...
		_parseSelect = &mml.Function{
			F: func(a []interface{}) interface{} {
				...
				return func() interface{} {
					...
					s["hasDefault"] = mml.Ref(_lines, "hasDefault")
					return s
				}()
				return nil
			},
			...
			F: func(a []interface{}) interface{} {
				...
				return func() interface{} {
					...
					s["definitions"] = _map.(*mml.Function).Call(append([]interface{}{}, &mml.Function{
						...
						FixedArgs: 1,
					})).(*mml.Function).Call(append([]interface{}{}, func() interface{} {
						c = mml.BinaryOp(11, mml.Ref(_d, "type"), "definition")
						if c.(bool) {
							return append([]interface{}{}, _d)
						} else {
		...
		_parseUse = &mml.Function{
			F: func(a []interface{}) interface{} {
				...
				return func() interface{} {
					s := make(map[string]interface{})
					s["type"] = "use-list"
					s["uses"] = _map.(*mml.Function).Call(append([]interface{}{}, _parse, mml.Ref(_ast, "nodes")))
					return s
				}()
				return nil
			},
		...
		_parse = &mml.Function{
			F: func(a []interface{}) interface{} {
				...
				default:
					...
					mml.Nop()
					_log.(*mml.Function).Call(append([]interface{}{}, "unexpected", mml.Ref(_ast, "name")))
					return _error.(*mml.Function).Call(append([]interface{}{}, "unexpected parser result"))
				}
				return nil
			},
			FixedArgs: 1,
		...
		_parseFile = &mml.Function{
			F: func(a []interface{}) interface{} {
				...
				c = _isError.(*mml.Function).Call(append([]interface{}{}, _ast))
				if c.(bool) {
					mml.Nop()
					return _ast
				}
			...
			F: func(a []interface{}) interface{} {
				...
				_usesModules = _map.(*mml.Function).Call(append([]interface{}{}, &mml.Function{
					F: func(a []interface{}) interface{} {
						...
						return func() interface{} {
							s := make(map[string]interface{})
							s["type"] = mml.Ref(_m, "type")
							s["path"] = mml.Ref(_m, "path")
							s["statements"] = mml.Ref(_m, "statements")
							s["exportNames"] = _findExportNames.(*mml.Function).Call(append([]interface{}{}, mml.Ref(_m, "statements")))
							return s
						}()
					},
					FixedArgs: 1,
				...
				_statements = _map.(*mml.Function).Call(append([]interface{}{}, &mml.Function{
					F: func(a []interface{}) interface{} {
						...
						if c.(bool) {
							...
							return func() interface{} {
								s := make(map[string]interface{})
								s["type"] = mml.Ref(_s, "type")
								s["path"] = mml.Ref(_s, "path")
								s["capture"] = mml.Ref(_s, "capture")
								s["exportNames"] = mml.Ref(mml.Ref(_m, 0), "exportNames")
								return s
							}()
						}
						return func() interface{} {
							s := make(map[string]interface{})
							s["type"] = mml.Ref(_s, "type")
							s["uses"] = _map.(*mml.Function).Call(append([]interface{}{}, &mml.Function{
								F: func(a []interface{}) interface{} {
									var c interface{}
									mml.Nop(c)
									var _u = a[0]
									...
									return func() interface{} {
										s := make(map[string]interface{})
										s["type"] = mml.Ref(_u, "type")
										s["path"] = mml.Ref(_u, "path")
										s["capture"] = mml.Ref(_u, "capture")
										s["exportNames"] = mml.Ref(mml.Ref(_m, 0), "exportNames")
										return s
									}()
									return nil
				...
				_pimpedCode = func() interface{} {
					s := make(map[string]interface{})
					s["type"] = mml.Ref(_code, "type")
					s["path"] = _path
					s["statements"] = _statements
					return s
				}()
