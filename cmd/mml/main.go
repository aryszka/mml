...
_destruct = &mml.Function{
			...
			F: func(a []interface{}) interface{} {
				...
				;
				mml.Nop(_key);
				return append([]interface{}{}, _key, mml.Ref(_s, _key))
			},
			FixedArgs: 1,
		})).(*mml.Function).Call(append([]interface{}{}, _keys.(*mml.Function).Call(append([]interface{}{}, _s))))
			},
			FixedArgs: 1,
		};
...
_readAll = &mml.Function{
			F: func(a []interface{}) interface{} {
				...
				;
				mml.Nop(_input);
				return _input.(*mml.Function).Call(append([]interface{}{}, mml.UnaryOp(2, 1)))
			},
			FixedArgs: 1,
		};
_read = &mml.Function{
			F: func(a []interface{}) interface{} {
				...
				;
				mml.Nop(_input);
				return _passErr.(*mml.Function).Call(append([]interface{}{}, _parse)).(*mml.Function).Call(append([]interface{}{}, _readAll.(*mml.Function).Call(append([]interface{}{}, _input))))
			},
			FixedArgs: 1,
		};
...
var _flat = a[1];
				;
				mml.Nop(_d, _flat);
				return func () interface{} { c = mml.BinaryOp(11, mml.Ref(_d, "type"), "definition"); if c.(bool) { return append(append([]interface{}{}, _flat.([]interface{})...), _d) } else { return append(append([]interface{}{}, _flat.([]interface{})...), mml.Ref(_d, "definitions").([]interface{})...) } }()
			},
			FixedArgs: 2,
			...
			F: func(a []interface{}) interface{} {
				...
				;
				mml.Nop(_s);
				return (_has.(*mml.Function).Call(append([]interface{}{}, "type", _s)).(bool) && (mml.BinaryOp(11, mml.Ref(_s, "type"), "definition").(bool) || mml.BinaryOp(11, mml.Ref(_s, "type"), "definition-list").(bool)))
			},
			FixedArgs: 1,
...
_builtin = map[string]interface{}{"len":"Len","isError":"IsError","keys":"Keys","format":"Format","stdin":"Stdin","stdout":"Stdout","stderr":"Stderr","string":"String","parse":"Parse","has":"Has","isBool":"IsBool","isInt":"IsInt","isFloat":"IsFloat","isString":"IsString","error":"Error"};
...
_write = _stdout;
_write.(*mml.Function).Call(append([]interface{}{}, "// Generated code\n\npackage main\n\nimport \"github.com/aryszka/mml\"\n"));
_write.(*mml.Function).Call(append([]interface{}{}, _builtins));
_write.(*mml.Function).Call(append([]interface{}{}, "\nfunc init() {\nvar c interface{}\nmml.Nop(c)\n"));
_onlyErr.(*mml.Function).Call(append([]interface{}{}, _log)).(*mml.Function).Call(append([]interface{}{}, _passErr.(*mml.Function).Call(append([]interface{}{}, _write)).(*mml.Function).Call(append([]interface{}{}, _passErr.(*mml.Function).Call(append([]interface{}{}, _compile)).(*mml.Function).Call(append([]interface{}{}, _read.(*mml.Function).Call(append([]interface{}{}, _stdin))))))));
_write.(*mml.Function).Call(append([]interface{}{}, "}\nfunc main() {}\n"))}
func main() {}
