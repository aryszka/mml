...
var __list = mml.Modules.Use("list.mml");;_fold = __list["fold"];
_foldr = __list["foldr"];
_map = __list["map"];
_filter = __list["filter"];
_contains = __list["contains"];
_sort = __list["sort"]
;var __strings = mml.Modules.Use("strings.mml");;_join = __strings["join"];
...
;var __errors = mml.Modules.Use("errors.mml");;_ifErr = __errors["ifErr"];
_not = __errors["not"];
_yes = __errors["yes"];
_passErr = __errors["passErr"];
_onlyErr = __errors["onlyErr"];
_anyErr = __errors["anyErr"]
;var __log = mml.Modules.Use("log.mml");;_log = __log["log"]
;var __compile = mml.Modules.Use("compile.mml");;_compile = __compile["compile"]
;var __parse = mml.Modules.Use("parse.mml");;_parseModules = __parse["parseModules"];
_builtin = map[string]interface{}{"len":"Len","isError":"IsError","keys":"Keys","format":"Format","stdin":"Stdin","stdout":"Stdout","stderr":"Stderr","string":"String","parse":"Parse","has":"Has","isBool":"IsBool","isInt":"IsInt","isFloat":"IsFloat","isString":"IsString","error":"Error","open":"Open","close":"Close","args":"Args","parseAST":"ParseAST","parseInt":"ParseInt"};
...
_escape = __strings["escape"];
_unescape = __strings["unescape"]
;var __ints = mml.Modules.Use("ints.mml");;_counter = __ints["counter"];
_enum = __ints["enum"]
;var __log = mml.Modules.Use("log.mml");;_log = __log["log"]
;var __statements = mml.Modules.Use("statements.mml");;_getFlattenedStatements = __statements["getFlattenedStatements"]
;var __code = mml.Modules.Use("code.mml");;_controlStatement = __code["controlStatement"];
...
_compileControl = &mml.Function{
			F: func(a []interface{}) interface{} {
				...
				;
				mml.Nop(_c);
				return func () interface{} { c = mml.BinaryOp(11, mml.Ref(_c, "control"), _breakControl); if c.(bool) { return "break" } else { return "continue" } }()
			},
			FixedArgs: 1,
		};
...
_selectSpread = &mml.Function{
			F: func(a []interface{}) interface{} {
				...
				;
				mml.Nop(_c);
				return func () interface{} { c = _isSpread.(*mml.Function).Call(append([]interface{}{}, _c)); if c.(bool) { return map[string]interface{}{"spread":_c} } else { return _c } }()
			},
			FixedArgs: 1,
		};
...
mml.Nop(_key, _value);
_key = func () interface{} { c = (_has.(*mml.Function).Call(append([]interface{}{}, "type", mml.Ref(_e, "key"))).(bool) && mml.BinaryOp(11, mml.Ref(mml.Ref(_e, "key"), "type"), "symbol").(bool)); if c.(bool) { return mml.Ref(mml.Ref(_e, "key"), "name") } else { return _compile.(*mml.Function).Call(append([]interface{}{}, mml.Ref(_e, "key"))) } }();
...
_fmt = func () interface{} { c = _multipleStatements; if c.(bool) { return "&mml.Function{\n\t\t\tF: func(a []interface{}) interface{} {\n\t\t\t\tvar c interface{}\n\t\t\t\tmml.Nop(c)\n\t\t\t\t%s;\n\t\t\t\t%s;\n\t\t\t\tmml.Nop(%s);\n\t\t\t\t%s;\n\t\t\t\treturn nil\n\t\t\t},\n\t\t\tFixedArgs: %d,\n\t\t}" } else { return "&mml.Function{\n\t\t\tF: func(a []interface{}) interface{} {\n\t\t\t\tvar c interface{}\n\t\t\t\tmml.Nop(c)\n\t\t\t\t%s;\n\t\t\t\t%s;\n\t\t\t\tmml.Nop(%s);\n\t\t\t\treturn %s\n\t\t\t},\n\t\t\tFixedArgs: %d,\n\t\t}" } }();
...
c = _isError.(*mml.Function).Call(append([]interface{}{}, _s)); if c.(bool) { ;
mml.Nop();
return _s };
...
c = _isError.(*mml.Function).Call(append([]interface{}{}, _exp)); if c.(bool) { ;
mml.Nop();
return _exp };
c = (!_has.(*mml.Function).Call(append([]interface{}{}, "type", mml.Ref(_i, "index"))).(bool) || mml.BinaryOp(12, mml.Ref(mml.Ref(_i, "index"), "type"), "range-expression").(bool)); if c.(bool) { var _index interface{};
mml.Nop(_index);
_index = _compile.(*mml.Function).Call(append([]interface{}{}, mml.Ref(_i, "index")));
c = _isError.(*mml.Function).Call(append([]interface{}{}, _index)); if c.(bool) { ;
mml.Nop();
return _index };
return _formats.(*mml.Function).Call(append([]interface{}{}, "mml.Ref(%s, %s)", _exp, _index)) };
_from = "nil";
c = _has.(*mml.Function).Call(append([]interface{}{}, "from", mml.Ref(_i, "index"))); if c.(bool) { ;
mml.Nop();
_from = _compile.(*mml.Function).Call(append([]interface{}{}, mml.Ref(mml.Ref(_i, "index"), "from")));
c = _isError.(*mml.Function).Call(append([]interface{}{}, _from)); if c.(bool) { ;
mml.Nop();
return _from } };
_to = "nil";
c = _has.(*mml.Function).Call(append([]interface{}{}, "to", mml.Ref(_i, "index"))); if c.(bool) { ;
mml.Nop();
_to = _compile.(*mml.Function).Call(append([]interface{}{}, mml.Ref(mml.Ref(_i, "index"), "to")));
c = _isError.(*mml.Function).Call(append([]interface{}{}, _to)); if c.(bool) { ;
mml.Nop();
return _to } };
...
_compileApplication = &mml.Function{
			F: func(a []interface{}) interface{} {
				...
				;
				mml.Nop(_a);
				return _passErrFormat.(*mml.Function).Call(append([]interface{}{}, func () interface{} { c = (_has.(*mml.Function).Call(append([]interface{}{}, "type", mml.Ref(_a, "function"))).(bool) && mml.BinaryOp(11, mml.Ref(mml.Ref(_a, "function"), "type"), "function").(bool)); if c.(bool) { return "(%s).Call(%s)" } else { return "%s.(*mml.Function).Call(%s)" } }(), _compile.(*mml.Function).Call(append([]interface{}{}, mml.Ref(_a, "function"))), _compileList.(*mml.Function).Call(append([]interface{}{}, map[string]interface{}{"values":mml.Ref(_a, "args")}))))
			},
			FixedArgs: 1,
		};
...
c = _isError.(*mml.Function).Call(append([]interface{}{}, _arg)); if c.(bool) { ;
mml.Nop();
return _arg };
...
;
mml.Nop();
c = !_isBool.(*mml.Function).Call(append([]interface{}{}, mml.Ref(_u, "arg"))).(bool); if c.(bool) { ;
mml.Nop();
...
c = (mml.BinaryOp(12, mml.Ref(_b, "op"), _logicalAnd).(bool) && mml.BinaryOp(12, mml.Ref(_b, "op"), _logicalOr).(bool)); if c.(bool) { ;
mml.Nop();
...
c = _isError.(*mml.Function).Call(append([]interface{}{}, _left)); if c.(bool) { ;
mml.Nop();
return _left };
_right = _compile.(*mml.Function).Call(append([]interface{}{}, mml.Ref(_b, "right")));
c = _isError.(*mml.Function).Call(append([]interface{}{}, _right)); if c.(bool) { ;
mml.Nop();
return _right };
...
_op = "&&";
c = mml.BinaryOp(11, mml.Ref(_b, "op"), _logicalOr); if c.(bool) { ;
mml.Nop();
_op = "||" };
...
_compileIf = &mml.Function{
			F: func(a []interface{}) interface{} {
				...
				;
				mml.Nop(_c);
				return func () interface{} { c = _has.(*mml.Function).Call(append([]interface{}{}, "alternative", _c)); if c.(bool) { return _passErrFormat.(*mml.Function).Call(append([]interface{}{}, "c = %s; if c.(bool) { %s } else { %s }", _compile.(*mml.Function).Call(append([]interface{}{}, mml.Ref(_c, "condition"))), _compile.(*mml.Function).Call(append([]interface{}{}, mml.Ref(_c, "consequent"))), _compile.(*mml.Function).Call(append([]interface{}{}, mml.Ref(_c, "alternative"))))) } else { return _passErrFormat.(*mml.Function).Call(append([]interface{}{}, "c = %s; if c.(bool) { %s }", _compile.(*mml.Function).Call(append([]interface{}{}, mml.Ref(_c, "condition"))), _compile.(*mml.Function).Call(append([]interface{}{}, mml.Ref(_c, "consequent"))))) } }()
			},
			FixedArgs: 1,
		};
...
_exp = func () interface{} { c = _has.(*mml.Function).Call(append([]interface{}{}, "expression", _s)); if c.(bool) { return _compile.(*mml.Function).Call(append([]interface{}{}, mml.Ref(_s, "expression"))) } else { return "" } }();
c = _isError.(*mml.Function).Call(append([]interface{}{}, _exp)); if c.(bool) { ;
mml.Nop();
return _exp };
...
c = _isError.(*mml.Function).Call(append([]interface{}{}, _cases)); if c.(bool) { ;
mml.Nop();
return _cases };
...
c = _isError.(*mml.Function).Call(append([]interface{}{}, _def)); if c.(bool) { ;
mml.Nop();
return _def };
_defaultCode = func () interface{} { c = _hasDefault; if c.(bool) { return _formats.(*mml.Function).Call(append([]interface{}{}, "default:\n%s", _def)) } else { return "" } }();
_casesCode = _join.(*mml.Function).Call(append([]interface{}{}, "\n", func () interface{} { c = _hasDefault; if c.(bool) { return append(append([]interface{}{}, _cases.([]interface{})...), _defaultCode) } else { return _cases } }()));
...
_compileDefinition = &mml.Function{
			F: func(a []interface{}) interface{} {
				...
				;
				mml.Nop(_d);
				return func () interface{} { c = mml.Ref(_d, "exported"); if c.(bool) { return _passErrFormat.(*mml.Function).Call(append([]interface{}{}, "_%s = %s; exports[\"%s\"] = _%s", mml.Ref(_d, "symbol"), _compile.(*mml.Function).Call(append([]interface{}{}, mml.Ref(_d, "expression"))), mml.Ref(_d, "symbol"), mml.Ref(_d, "symbol"))) } else { return _passErrFormat.(*mml.Function).Call(append([]interface{}{}, "_%s = %s", mml.Ref(_d, "symbol"), _compile.(*mml.Function).Call(append([]interface{}{}, mml.Ref(_d, "expression"))))) } }()
			},
			FixedArgs: 1,
		};
...
c = _isError.(*mml.Function).Call(append([]interface{}{}, _statements)); if c.(bool) { ;
mml.Nop();
return _statements };
...
;
mml.Nop();
return _breakControl
case "continue":
;
mml.Nop();
return _continueControl
default:
;
mml.Nop();
return map[string]interface{}{"type":"symbol","name":mml.Ref(_ast, "text")}
};
				return nil
			},
			FixedArgs: 1,
...
_parseSpread = &mml.Function{
			F: func(a []interface{}) interface{} {
				...
				;
mml.Nop();
return map[string]interface{}{"type":"spread","value":_parse.(*mml.Function).Call(append([]interface{}{}, mml.Ref(mml.Ref(_ast, "nodes"), 0)))};
				return nil
			},
			FixedArgs: 1,
		};
...
_parseList = &mml.Function{
			F: func(a []interface{}) interface{} {
				...
				;
mml.Nop();
return map[string]interface{}{"type":"list","values":_parseExpressionList.(*mml.Function).Call(append([]interface{}{}, mml.Ref(_ast, "nodes")))};
				return nil
			},
			FixedArgs: 1,
		};
_parseMutableList = &mml.Function{
			F: func(a []interface{}) interface{} {
				...
				var _l interface{};
mml.Nop(_l);
_l = _parseList.(*mml.Function).Call(append([]interface{}{}, _ast));
return map[string]interface{}{"type":mml.Ref(_l, "type"),"values":mml.Ref(_l, "values"),"mutable":true};
				return nil
			},
			FixedArgs: 1,
		};
_parseExpressionKey = &mml.Function{
			F: func(a []interface{}) interface{} {
				...
				;
mml.Nop();
return map[string]interface{}{"type":"expression-key","value":_parse.(*mml.Function).Call(append([]interface{}{}, mml.Ref(mml.Ref(_ast, "nodes"), 0)))};
				return nil
			},
			FixedArgs: 1,
		};
_parseEntry = &mml.Function{
			F: func(a []interface{}) interface{} {
				...
				;
mml.Nop();
return map[string]interface{}{"type":"entry","key":_parse.(*mml.Function).Call(append([]interface{}{}, mml.Ref(mml.Ref(_ast, "nodes"), 0))),"value":_parse.(*mml.Function).Call(append([]interface{}{}, mml.Ref(mml.Ref(_ast, "nodes"), 1)))};
				return nil
			},
			FixedArgs: 1,
		};
_parseStruct = &mml.Function{
			F: func(a []interface{}) interface{} {
				...
				;
mml.Nop();
return map[string]interface{}{"type":"struct","entries":_map.(*mml.Function).Call(append([]interface{}{}, _parse, mml.Ref(_ast, "nodes")))};
				return nil
			},
			FixedArgs: 1,
		};
_parseMutableStruct = &mml.Function{
			F: func(a []interface{}) interface{} {
				...
				var _s interface{};
mml.Nop(_s);
_s = _parseStruct.(*mml.Function).Call(append([]interface{}{}, _ast));
return map[string]interface{}{"type":mml.Ref(_s, "type"),"entries":mml.Ref(_s, "entries"),"mutable":true};
				return nil
			},
			FixedArgs: 1,
		};
_parseReturn = &mml.Function{
			F: func(a []interface{}) interface{} {
				...
				;
mml.Nop();
return func () interface{} { c = mml.BinaryOp(11, _len.(*mml.Function).Call(append([]interface{}{}, mml.Ref(_ast, "nodes"))), 0); if c.(bool) { return map[string]interface{}{"type":"ret"} } else { return map[string]interface{}{"type":"ret","value":_parse.(*mml.Function).Call(append([]interface{}{}, mml.Ref(mml.Ref(_ast, "nodes"), 0)))} } }();
				return nil
			},
			FixedArgs: 1,
		};
_parseStatementList = &mml.Function{
			F: func(a []interface{}) interface{} {
				...
				;
mml.Nop();
return map[string]interface{}{"type":"statement-list","statements":_map.(*mml.Function).Call(append([]interface{}{}, mml.Ref(_ast, "nodes"), _parse))};
				return nil
			},
			FixedArgs: 1,
		};
...
return map[string]interface{}{"type":"function","params":_map.(*mml.Function).Call(append([]interface{}{}, &mml.Function{
			F: func(a []interface{}) interface{} {
				var c interface{}
				mml.Nop(c)
				var _p = a[0];
			...
			FixedArgs: 1,
		})).(*mml.Function).Call(append([]interface{}{}, _map.(*mml.Function).Call(append([]interface{}{}, _parse)).(*mml.Function).Call(append([]interface{}{}, _fixedParams)))),"collectParam":func () interface{} { c = _hasCollectParam; if c.(bool) { return mml.Ref(_parse.(*mml.Function).Call(append([]interface{}{}, mml.Ref(mml.Ref(mml.Ref(_params, _last), "nodes"), 0))), "name") } else { return "" } }(),"statement":_parse.(*mml.Function).Call(append([]interface{}{}, mml.Ref(_nodes, _last)))};
				return nil
			},
			FixedArgs: 1,
		};
...
_parseEffect = &mml.Function{
			F: func(a []interface{}) interface{} {
				...
				var _f interface{};
mml.Nop(_f);
_f = _parseFunction.(*mml.Function).Call(append([]interface{}{}, _ast));
return map[string]interface{}{"type":mml.Ref(_f, "type"),"params":mml.Ref(_f, "params"),"collectParam":mml.Ref(_f, "collectParam"),"statement":mml.Ref(_f, "statement"),"effect":true};
				return nil
			},
			FixedArgs: 1,
		};
...
return func () interface{} { c = mml.BinaryOp(11, mml.Ref(_ast, "Name"), "range-from"); if c.(bool) { return map[string]interface{}{"type":"range-expression","from":_v} } else { return map[string]interface{}{"type":"range-expression","to":_v} } }();
				return nil
			},
			FixedArgs: 1,
		};
_parseIndexerNodes = &mml.Function{
			F: func(a []interface{}) interface{} {
				...
				;
mml.Nop();
return map[string]interface{}{"type":"indexer","expression":func () interface{} { c = mml.BinaryOp(11, _len.(*mml.Function).Call(append([]interface{}{}, _n)), 2); if c.(bool) { return _parse.(*mml.Function).Call(append([]interface{}{}, mml.Ref(_n, 0))) } else { return _parseIndexerNodes.(*mml.Function).Call(append([]interface{}{}, mml.RefRange(_n, nil, mml.BinaryOp(10, _len.(*mml.Function).Call(append([]interface{}{}, _n)), 1)))) } }(),"index":_parse.(*mml.Function).Call(append([]interface{}{}, mml.Ref(_n, mml.BinaryOp(10, _len.(*mml.Function).Call(append([]interface{}{}, _n)), 1))))};
				return nil
			},
			FixedArgs: 1,
		};
...
_parseFunctionApplication = &mml.Function{
			F: func(a []interface{}) interface{} {
				...
				;
mml.Nop();
return map[string]interface{}{"function":_parse.(*mml.Function).Call(append([]interface{}{}, mml.Ref(mml.Ref(_ast, "nodes"), 0))),"args":_parseExpressionList.(*mml.Function).Call(append([]interface{}{}, mml.RefRange(mml.Ref(_ast, "nodes"), 1, nil)))};
				return nil
			},
			FixedArgs: 1,
		};
...
return map[string]interface{}{"type":"unary","op":_op,"arg":_parse.(*mml.Function).Call(append([]interface{}{}, mml.Ref(mml.Ref(_ast, "nodes"), 1)))};
				return nil
			},
			FixedArgs: 1,
		};
...
return map[string]interface{}{"type":"binary","op":_op,"left":_parse.(*mml.Function).Call(append([]interface{}{}, func () interface{} { c = mml.BinaryOp(15, _len.(*mml.Function).Call(append([]interface{}{}, mml.Ref(_ast, "nodes"))), 3); if c.(bool) { return map[string]interface{}{"name":mml.Ref(_ast, "name"),"nodes":mml.RefRange(mml.Ref(_ast, "nodes"), nil, mml.BinaryOp(10, _len.(*mml.Function).Call(append([]interface{}{}, mml.Ref(_ast, "nodes"))), 2))} } else { return mml.Ref(mml.Ref(_ast, "nodes"), 0) } }())),"right":_parse.(*mml.Function).Call(append([]interface{}{}, mml.Ref(mml.Ref(_ast, "nodes"), mml.BinaryOp(10, _len.(*mml.Function).Call(append([]interface{}{}, mml.Ref(_ast, "nodes"))), 1))))};
				return nil
			},
			FixedArgs: 1,
		};
...
mml.Nop();
return _a };
_a = map[string]interface{}{"function":_parse.(*mml.Function).Call(append([]interface{}{}, mml.Ref(_n, 0))),"args":append([]interface{}{}, _a)};
...
_parserTernary = &mml.Function{
			F: func(a []interface{}) interface{} {
				...
				;
mml.Nop();
return map[string]interface{}{"type":"cond","condition":_parse.(*mml.Function).Call(append([]interface{}{}, mml.Ref(mml.Ref(_ast, "nodes"), 0))),"consequent":_parse.(*mml.Function).Call(append([]interface{}{}, mml.Ref(mml.Ref(_ast, "nodes"), 1))),"alternative":_parse.(*mml.Function).Call(append([]interface{}{}, mml.Ref(mml.Ref(_ast, "nodes"), 2))),"ternary":true};
				return nil
			},
			FixedArgs: 1,
		};
